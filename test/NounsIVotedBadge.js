...
describe("NounsIVoted", function () {
  ...
  IMPERSONATE: 0x281eC184E704CE57570614C33B3477Ec7Ff07243
  prop 270 voted ABSTAIN  
  ...
  */
  ...
  it("Should revert with address not voted in proposal", async function () {
    await expect(mainContract.connect(acc1).claimBadge(270)).to.be.revertedWithCustomError(
      mainContract, 
